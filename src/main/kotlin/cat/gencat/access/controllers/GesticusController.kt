...
class GesticusController : Controller() {
    ...
    fun doSendAskForNewsToSSTTNotification() = gesticusDb.doSendAskForNewsToSSTTNotification()
    ...
    fun sendEmailADirectors(email: Email) = gesticusDb.sendEmailToDirectors(email)
