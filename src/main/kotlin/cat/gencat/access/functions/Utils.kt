...
const val BODY_INICIADA: String =
        "$EMAIL_HEADER<p>?1</p><br><p>Segons consta en els nostres arxius, heu començat o properament començareu la vostra estada formativa en empresa de tipus B número ?2.</p><p>Recordeu que la vostra estada esta condicionada a que el/la substitut/a prengui possessió de la vostra plaça.</p><br>$EMAIL_FOOTER"
