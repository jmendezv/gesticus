...
class GesticusView : View(Utils.APP_TITLE) {
    ...
    val comunicatsMenuItemPrintCartaEmpresaPrivat: MenuItem by fxid()
    ...
    val comunicatsMenuItemCorreuEmpresaPrivat: MenuItem by fxid()
...
//                }
    ...
    private fun doSetup() {
        ...
        comunicatsMenuItemPrintCartaEmpresaPrivat.setOnAction {
            if (checkForEmptyOrNull()) return@setOnAction
            val registre = gatherDataFromForm()
        ...
        comunicatsMenuItemCorreuEmpresaPrivat.setOnAction {
            if (checkForEmptyOrNull()) return@setOnAction
            val registre = gatherDataFromForm()
            buttonProgressIndicator.runAsyncWithProgress {
                buttonProgressIndicator.isVisible = true
