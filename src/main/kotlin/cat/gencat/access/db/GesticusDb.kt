...
const val findLastEstadaNumberQuery: String = "SELECT estades_t.id AS estades_id, estades_t.codi AS estades_codi " +
        "FROM estades_t ORDER BY [estades_id] DESC LIMIT 1;"
...
const val deleteBaremDocentsResultatQuery: String =
...
const val selectBaremPrivatQuery =
        """SELECT barem_docents_t.nif AS NIF, barem_docents_t.nom AS [Cognoms i nom], centres_t.NOM_Centre AS [Centre], barem_docents_t.nota_projecte AS [Projecte], barem_docents_t.nota_antiguitat AS [Antiguitat], barem_docents_t.nota_catedratic AS [Catedràtic], barem_docents_t.nota_formacio AS [Formació], barem_docents_t.nota_treballs_desenvolupats AS [Treballs Al·legats], barem_docents_t.nota_altres_titulacions AS [Altres Titulacions], barem_docents_resultat_t.nota_individual AS [Total]
...
//                    val avui = Date()
    ...
    fun doSendTancamentNotification(): Unit {
...
//                    CSVConst.ACTVITAT_VALUE_CODI_MATERIA,
                    ...
                    CSVConst.ACTVITAT_VALUE_CODI_MATRICULACIO,
                    CSVConst.ACTVITAT_VALUE_CODI_MODALITAT,
                    CSVConst.ACTVITAT_VALUE_CODI_MODALITAT_GESTIO,
                    CSVConst.ACTVITAT_VALUE_CODI_MODEL_CERTIFICAT,
                    CSVConst.ACTVITAT_VALUE_CODI_MUNICIPI,
                    CSVConst.ACTVITAT_VALUE_CODI_NIVELL,
                    CSVConst.ACTVITAT_VALUE_CODI_PROCES_INSCRIPCIO,
                    CSVConst.ACTVITAT_VALUE_CODI_PROGRAMA,
                    CSVConst.ACTVITAT_VALUE_CODI_PUBLICACIO,
                    CSVConst.ACTVITAT_VALUE_CODI_STATUS,
                    CSVConst.ACTVITAT_VALUE_CODI_TIPUS_ACTIVITAT,
                    CSVConst.ACTVITAT_VALUE_CODI_TIPUS_SEMINARI,
                    CSVConst.ACTVITAT_VALUE_CODI_VALIDACIO_CENTRE,
                    CSVConst.ACTVITAT_VALUE_DATA_BLOQ_ECO,
                    CSVConst.ACTVITAT_VALUE_DATA_BLOQUEIG_RESPONSABLE,
                    CSVConst.ACTVITAT_VALUE_DATA_FI_ASSIGNACIO,
...
//                CSVConst.ACTVITAT_VALUE_DATA_INICI,
                    ...
                    CSVConst.ACTVITAT_VALUE_DATA_RESOLUCIO,
                    CSVConst.ACTVITAT_VALUE_DATA_TRASPAS_ODISSEA,
                    CSVConst.ACTVITAT_VALUE_IND_ALTRES_REQUISITS,
                    CSVConst.ACTVITAT_VALUE_IND_INSCRIPCIO,
                    CSVConst.ACTVITAT_VALUE_IND_RESTRICCIO_CENTRE,
                    CSVConst.ACTVITAT_VALUE_IND_SENSE_COST,
...
//                    CSVConst.ACTVITAT_VALUE_NOM_ACTIVITAT,
                    ...
                    CSVConst.ACTVITAT_VALUE_NOM_OBJECTIUS,
                    CSVConst.ACTVITAT_VALUE_NOM_OBSERVACION, // ?
                    CSVConst.ACTVITAT_VALUE_NOM_OBSERVACIONS,
                    CSVConst.ACTVITAT_VALUE_NOM_PREGUNTA,
                    CSVConst.ACTVITAT_VALUE_NOM_RESPONSABLE,
                    CSVConst.ACTVITAT_VALUE_NOM_TITOL,
                    CSVConst.ACTVITAT_VALUE_NUM_DESPESES_DESPLACAMENT,
                    CSVConst.ACTVITAT_VALUE_NUM_DESPESES_DOCENCIA,
                    CSVConst.ACTVITAT_VALUE_NUM_DESPESES_GENERALS,
                    CSVConst.ACTVITAT_VALUE_NUM_DIES_MARGE_FINAL,
                    CSVConst.ACTVITAT_VALUE_NUM_DIES_MARGE_INICIAL,
                    CSVConst.ACTVITAT_VALUE_NUM_HORA_FINAL,
...
//                    CSVConst.ACTVITAT_VALUE_NUM_HORES_PREVISTES,
                    ...
                    CSVConst.ACTVITAT_VALUE_OBSERVACIONS_LLOC,
                    CSVConst.ACTVITAT_VALUE_PLA_AVALUACIO,
                    CSVConst.ACTVITAT_VALUE_REQUISITS_CERTIFICACIO,
                    CSVConst.ACTVITAT_VALUE_USER_BLOQ_ECO,
...
//                CSVConst.ALUMNE_VALUE_CODI_CENTRE_TREBALL,
...
//                CSVConst.ALUMNE_VALUE_CODI_PERSONA,
                    ...
                    CSVConst.ALUMNE_VALUE_IND_ALTRES_REQUISITS,
                    CSVConst.ALUMNE_VALUE_IND_CERTIFICAT,
                    CSVConst.ALUMNE_VALUE_NOM_CLAU_ACCESS,
                    CSVConst.ALUMNE_VALUE_NOM_IP,
                    CSVConst.ALUMNE_VALUE_NOM_MAQUINA,
...
//        countTotalEstadesPerCosStatement.setString(1, currentCourseYear())
    ...
    *
    * SELECT
    * barem_docents_t.Id as barem_id,
    * barem_docents_t.nif as barem_nif,
    * barem_docents_t.nom as barem_nom,
    * barem_docents_t.email as barem_email,
    * barem_docents_t.curs as barem_curs,
    * barem_docents_t.privat as barem_privat,
    * barem_docents_t.nou as barem_cicle_nou,
    * barem_docents_t.dual as barem_dual,
    * barem_docents_t.grup as barem_grup,
    * barem_docents_t.interi as barem_interi,
    * barem_docents_t.repetidor as barem_repetidor,
    * barem_docents_t.nota_projecte as barem_nota_projecte,
    * barem_docents_t.nota_antiguitat as barem_nota_antiguitat,
    * barem_docents_t.nota_formacio as barem_nota_formacio,
    * barem_docents_t.nota_treballs_desenvolupats as barem_nota_treball_desenvolupats,
    * barem_docents_t.nota_altres_titulacions as barem_nota_altres_titulacions,
    * barem_docents_t.nota_catedratic as barem_nota_catedratic,
    * barem_docents_t.codi_grup as barem_codi_grup,
    * barem_docents_t.nota_individual as barem_nota_individual,
    * barem_docents_t.nota_grup as barem_nota_grup,
    * barem_docents_t.comentaris as barem_comentaris
    * FROM barem_docents_t
    * WHERE barem_docents_t.curs = ?
    * ORDER BY barem_docents_t.nota_projecte;
    *
    * */
    ...
    * */
    ...
    fun deleteBaremDocentsResultat() {
        val baremStatement = conn.createStatement()
        baremStatement.execute(deleteBaremDocentsResultatQuery)
    }

    /*
    * insertBaremDocentsResultatQuery
    *
    * INSERT INTO
    ...
    * barem_docents_t.nota_altres_titulacions AS [Altres Titulacions],
    ...
    * */
    fun selectBaremPrivat(): MutableList<BaremResult> {
        ...
        baremStatement.setString(1, preferencesCurrentCourse())
        val result = baremStatement.executeQuery()
        val barems = mutableListOf<BaremResult>()
        while (result.next()) {
            with(result) {
                val nif = getString("NIF")
                val nom = getString("Cognoms i Nom")
                val centre = getString("Centre")
                val notaProjecte = getDouble("Projecte")
                val notaAntiguitat = getDouble("Antiguitat")
                val notaCatedratic = getDouble("Catedràtic")
                val notaFormacio = getDouble("Formació")
                val notaTreballs = getDouble("Treballs Al·legats")
                val notaAltresTitulacions = getDouble("Altres Titulacions")
    ...
    * */
    ...
    fun getDocentsPerFamiliaYMunicipi(
            familia: String,
            municipi: String = "TOTHOM"
    ...
    * */
    fun sendEmailADocents(email: Email) {
        val professors: List<Triple<String, String, String>> =
                getDocentsPerFamiliaYMunicipi(email.pera, email.territori)
    ...
    * */
    fun doResumCurs() {
        ...
        while (allCentresResultSet.next()) {
            ...
            val allEstadesResultSet = allEstades.executeQuery()
            var llistat =
                    StringBuilder("<table><tr><th>Número</th><th>Docent</th><th>Empresa</th><th>Data inici</th><th>Data final</th></tr>")
            var carrec = ""
            var email = ""
            while (allEstadesResultSet.next()) {
